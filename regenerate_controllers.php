<?php
// Script to regenerate controllers without typed properties - Run: php regenerate_controllers.php
...
// Template WITHOUT typed properties to match parent class
$template = '<?php
...
echo "\n✅ All controllers regenerated without typed properties!\n";
