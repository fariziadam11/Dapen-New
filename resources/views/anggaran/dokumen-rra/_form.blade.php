...
<div class="col-md-6 mb-3">
    ...
    <input type="text" name="nomor_nota" class="form-control @error('nomor_nota') is-invalid @enderror" value="{{ old('nomor_nota', $record->nomor_nota ?? '') }}" >
    @error('nomor_nota')<div class="invalid-feedback">{{ $message }}</div>@enderror
</div>
<div class="col-md-6 mb-3">
    <label class="form-label">Nomor Sukka </label>
    <input type="text" name="nomor_sukka" class="form-control @error('nomor_sukka') is-invalid @enderror" value="{{ old('nomor_sukka', $record->nomor_sukka ?? '') }}" >
    @error('nomor_sukka')<div class="invalid-feedback">{{ $message }}</div>@enderror
</div>
