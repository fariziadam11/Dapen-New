...
<div class="row">
    ...
    <input type="date" name="tanggal_surat_bayar" class="form-control @error('tanggal_surat_bayar') is-invalid @enderror" value="{{ old('tanggal_surat_bayar', $record->tanggal_surat_bayar ?? '') }}" >
    @error('tanggal_surat_bayar')<div class="invalid-feedback">{{ $message }}</div>@enderror
</div>
<div class="col-md-6 mb-3">
    <label class="form-label">Nomor Surat Bayar </label>
    <input type="text" name="nomor_surat_bayar" class="form-control @error('nomor_surat_bayar') is-invalid @enderror" value="{{ old('nomor_surat_bayar', $record->nomor_surat_bayar ?? '') }}" >
    @error('nomor_surat_bayar')<div class="invalid-feedback">{{ $message }}</div>@enderror
</div>
