...
<div class="row">
    ...
    <input type="text" name="periode" class="form-control @error('periode') is-invalid @enderror" value="{{ old('periode', $record->periode ?? '') }}" >
    @error('periode')<div class="invalid-feedback">{{ $message }}</div>@enderror
</div>
<div class="col-md-6 mb-3">
    <label class="form-label">Kategori </label>
    <input type="text" name="kategori" class="form-control @error('kategori') is-invalid @enderror" value="{{ old('kategori', $record->kategori ?? '') }}" >
...
<div class="col-md-6 mb-3">
    ...
    <input type="text" name="dilaporkan" class="form-control @error('dilaporkan') is-invalid @enderror" value="{{ old('dilaporkan', $record->dilaporkan ?? '') }}" >
    @error('dilaporkan')<div class="invalid-feedback">{{ $message }}</div>@enderror
</div>
