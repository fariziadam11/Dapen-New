<div class="row">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <select name="kategori" id="kategori" class="form-select @error('kategori') is-invalid @enderror" required>
                ...
                @foreach (['PRBC', 'Rapat Pengurus', 'Rapat Gabungan', 'Rapat Sekretariat', 'Lainnya'] as $cat)
                    <option value="{{ $cat }}"
    ...
    <div class="col-md-12">
        <div class="mb-3">
            ...
            <textarea name="peserta" id="peserta" class="form-control @error('peserta') is-invalid @enderror" rows="3">{{ old('peserta', $item->peserta ?? '') }}</textarea>
            @error('peserta')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
