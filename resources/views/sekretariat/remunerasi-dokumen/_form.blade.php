<div class="row">
    ...
    <div class="col-md-6 mb-3">
        ...
        <select name="kategori" class="form-select @error('kategori') is-invalid @enderror">
            ...
            <option value="Bulanan" {{ old('kategori', $item->kategori ?? '') == 'Bulanan' ? 'selected' : '' }}>Bulanan</option>
            <option value="THR" {{ old('kategori', $item->kategori ?? '') == 'THR' ? 'selected' : '' }}>THR</option>
            <option value="Jasa Usaha" {{ old('kategori', $item->kategori ?? '') == 'Jasa Usaha' ? 'selected' : '' }}>Jasa Usaha</option>
        </select>
