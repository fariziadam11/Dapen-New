                        ...
                        <tr>
                            ...
                            <td>
                                @if ($item->file_name)
                                    <div class="btn-group btn-group-sm">
                                        <button onclick="previewFile('{{ route('logistik.procurement.preview', $item->id) }}', '{{ $item->file_name }}')" class="btn btn-outline-primary" title="Preview"><i class="bi bi-eye"></i></button>
                                        <a href="{{ route('logistik.procurement.download', $item->id) }}" class="btn btn-outline-success" title="Download"><i class="bi bi-download"></i></a>
                                    </div>
                                @else
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    ...
                                    <form action="{{ route('logistik.procurement.destroy', $item->id) }}" method="POST" class="d-inline">
                                        @csrf @method('DELETE')
