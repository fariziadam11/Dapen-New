...
<div class="row">
    ...
    <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama', $record->nama ?? '') }}" >
    @error('nama')<div class="invalid-feedback">{{ $message }}</div>@enderror
</div>
<div class="col-md-6 mb-3">
    <label class="form-label">Mulai </label>
    <input type="date" name="mulai" class="form-control @error('mulai') is-invalid @enderror" value="{{ old('mulai', $record->mulai ?? '') }}" >
    @error('mulai')<div class="invalid-feedback">{{ $message }}</div>@enderror
</div>
<div class="col-md-6 mb-3">
    <label class="form-label">Akhir </label>
    <input type="date" name="akhir" class="form-control @error('akhir') is-invalid @enderror" value="{{ old('akhir', $record->akhir ?? '') }}" >
