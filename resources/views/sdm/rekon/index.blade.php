                        ...
                        <tr>
                            ...
                            <td>
                                @if ($item->file_name)
                                    <div class="btn-group btn-group-sm"><button
                                            ...
                                            href="{{ route('sdm.rekon.download', $item->id) }}"
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    <a href="{{ route('sdm.rekon.show', $item->id) }}" class="btn btn-outline-primary"><i
                                            class="bi bi-eye"></i></a>
                                    <a href="{{ route('sdm.rekon.edit', $item->id) }}" class="btn btn-outline-warning"><i
                                            class="bi bi-pencil"></i></a>
                                    <form action="{{ route('sdm.rekon.destroy', $item->id) }}" method="POST"
