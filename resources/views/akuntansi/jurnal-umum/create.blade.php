@extends('layouts.app')
@section('title', (isset($record) ? 'Edit' : 'Tambah') . ' - ' . ($moduleName ?? 'Jurnal Umum'))
@section('breadcrumb')
<li class="breadcrumb-item"><a href="#">Akuntansi</a></li>
<li class="breadcrumb-item"><a href="{{ route($routePrefix . '.index') }}">Jurnal Umum</a></li>
<li class="breadcrumb-item active">{{ isset($record) ? 'Edit' : 'Tambah' }}</li>
@endsection
@section('content')
<div class="page-header mb-4"><h1 class="page-title">{{ isset($record) ? 'Edit' : 'Tambah' }} {{ $moduleName ?? 'Jurnal Umum' }}</h1></div>
