{{-- Form fields for Compliance Check --}}
<div class="row">
    ...
    <div class="col-md-6 mb-3">
        ...
        <textarea name="perihal" class="form-control @error('perihal') is-invalid @enderror" rows="3" required>{{ old('perihal', $record->perihal ?? '') }}</textarea>
        @error('perihal')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
