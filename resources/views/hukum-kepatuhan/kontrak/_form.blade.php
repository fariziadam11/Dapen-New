...
<div class="col-md-6 mb-3">
    ...
    <input type="text" name="nomor" class="form-control @error('nomor') is-invalid @enderror" value="{{ old('nomor', $record->nomor ?? '') }}" >
...
<div class="col-md-6 mb-3">
    ...
    <input type="date" name="berlaku_awal" class="form-control @error('berlaku_awal') is-invalid @enderror" value="{{ old('berlaku_awal', $record->berlaku_awal ?? '') }}" >
    @error('berlaku_awal')<div class="invalid-feedback">{{ $message }}</div>@enderror
</div>
<div class="col-md-6 mb-3">
    <label class="form-label">Berlaku Sampai </label>
    <input type="date" name="berlaku_akhir" class="form-control @error('berlaku_akhir') is-invalid @enderror" value="{{ old('berlaku_akhir', $record->berlaku_akhir ?? '') }}" >
    @error('berlaku_akhir')<div class="invalid-feedback">{{ $message }}</div>@enderror
</div>
<div class="col-md-6 mb-3">
    <label class="form-label">Jenis </label>
    <input type="text" name="jenis" class="form-control @error('jenis') is-invalid @enderror" value="{{ old('jenis', $record->jenis ?? '') }}" >
    @error('jenis')<div class="invalid-feedback">{{ $message }}</div>@enderror
</div>
<div class="col-md-6 mb-3">
    <label class="form-label">Pihak </label>
    <input type="text" name="pihak" class="form-control @error('pihak') is-invalid @enderror" value="{{ old('pihak', $record->pihak ?? '') }}" >
    @error('pihak')<div class="invalid-feedback">{{ $message }}</div>@enderror
</div>
<div class="col-md-6 mb-3">
    <label class="form-label">Pemilik </label>
    <input type="text" name="pemilik" class="form-control @error('pemilik') is-invalid @enderror" value="{{ old('pemilik', $record->pemilik ?? '') }}" >
...
<div class="col-md-6 mb-3">
    ...
    <select name="status" class="form-select @error('status') is-invalid @enderror" >
        ...
        <option value="Tidak Aktif" {{ old('status', $record->status ?? '') == Tidak Aktif ? 'selected' : '' }}>Tidak Aktif</option>
    </select>
