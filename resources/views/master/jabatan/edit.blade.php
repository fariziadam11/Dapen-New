@extends('layouts.app')
@section('title', (isset($record) ? 'Edit' : 'Tambah') . ' - ' . ($moduleName ?? 'Jabatan'))
@section('breadcrumb')
<li class="breadcrumb-item"><a href="#">Master</a></li>
<li class="breadcrumb-item"><a href="{{ route($routePrefix . '.index') }}">Jabatan</a></li>
<li class="breadcrumb-item active">{{ isset($record) ? 'Edit' : 'Tambah' }}</li>
@endsection
@section('content')
<div class="page-header mb-4"><h1 class="page-title">{{ isset($record) ? 'Edit' : 'Tambah' }} {{ $moduleName ?? 'Jabatan' }}</h1></div>
